...
const translations = {
  en: {
    common: { refresh: "Refresh", save: "Save", cancel: "Cancel", delete: "Delete", edit: "Edit", add: "Add", search: "Search", filter: "Filter", export: "Export", import: "Import", upload: "Upload", download: "Download", close: "Close", confirm: "Confirm", back: "Back", next: "Next", done: "Done", loading: "Loading...", noData: "No data available", error: "Error", success: "Success", warning: "Warning", info: "Info", actions: "Actions", view: "View", copyLink: "Copy Link", exportCsv: "Export CSV", bulkUpload: "Bulk Upload", bulkUpdate: "Bulk Update", selectAll: "Select All", deselectAll: "Deselect All", selected: "Selected", items: "items", yes: "Yes", no: "No", name: "Name", email: "Email", phone: "Phone", address: "Address", date: "Date", status: "Status", total: "Total", empty: "Empty", page: "Page", of: "of", to: "to", from: "From" },
    sidebar: { dashboard: "Dashboard", skus_products: "SKUs / Products", orders: "Orders", profitability: "Profitability", purchase_requests: "Purchase Requests", purchases: "Purchases", returns: "Returns", suppliers: "Suppliers & Stores", tasks: "Tasks", team: "Team", settings: "Settings", backup_data: "Backup & Data", admin_tools: "Admin Tools", platform_admin: "Platform Admin", emergency_restore: "Emergency Restore", rate_limit_monitor: "Rate Limit Monitor", system_monitoring: "System Monitoring", sign_out: "Sign Out", owner_log: "Owner Log", no_workspaces: "No Workspaces Assigned", contact_admin: "Contact the app administrator to request workspace access", suppliers_stores: "Suppliers & Stores" },
    ...
    skus: { title: "SKUs / Products", subtitle: "Manage your product inventory", addSku: "Add SKU", bulkUpload: "Bulk Upload", bulkUpdate: "Bulk Update", exportCsv: "Export CSV", template: "Download Template", checkIntegrity: "Check Integrity", resetAllStockToZero: "Reset All Stock to Zero", clearStock: "Clear Stock", deleteSelected: "Delete Selected", searchPlaceholder: "Search by SKU code or title...", filters: { all: "All Products", lowStock: "Low Stock", outOfStock: "Out of Stock", newestFirst: "Newest First", oldestFirst: "Oldest First", rowsPerPage: "Rows per page" }, empty: { title: "No products yet", subtitle: "Add your first product to get started" }, table: { skuCode: "SKU Code", title: "Title", currentStock: "Current Stock", costPrice: "Cost Price", sellingPrice: "Selling Price", supplier: "Supplier", createdDate: "Created Date" }, integrity: { title: "Stock Integrity Check", checking: "Checking stock integrity...", noIssues: "No issues found", issuesFound: "Issues found", fix: "Fix Issues" }, kpis: { lowStockItems: "Low Stock Items", totalAvailableQuantity: "Total Available Quantity", stockValue: "Stock Value", totalSkus: "Total SKUs" }, csvColumns: "CSV Columns Required", columnLabels: { imageUrl: "image_url", stock: "stock", supplier: "supplier", cost: "cost", productName: "product_name", skuCode: "sku_code" }, refresh: "Refresh", delete: "Delete" },
    ...
    messages: { saveSuccess: "Saved successfully", deleteSuccess: "Deleted successfully", updateSuccess: "Updated successfully", uploadSuccess: "Uploaded successfully", copiedToClipboard: "Copied to clipboard", confirmDelete: "Are you sure you want to delete this item?", confirmAction: "Are you sure you want to proceed?", noChanges: "No changes made", loading: "Loading...", pleaseWait: "Please wait...", loadingWorkspace: "Loading workspace...", loadingData: "Loading data...", workspaceSwitched: "Workspace switched successfully", errorLoadingData: "Error loading data", retryLoad: "Retry", selectWorkspace: "Select a workspace", noAccess: "You don't have access to this resource" },
  },
  ar: {
    common: { refresh: "تحديث", save: "حفظ", cancel: "إلغاء", delete: "حذف", edit: "تعديل", add: "إضافة", search: "بحث", filter: "تصفية", export: "تصدير", import: "استيراد", upload: "رفع", download: "تنزيل", close: "إغلاق", confirm: "تأكيد", back: "رجوع", next: "التالي", done: "تم", loading: "جاري التحميل...", noData: "لا توجد بيانات", error: "خطأ", success: "نجح", warning: "تحذير", info: "معلومات", actions: "إجراءات", view: "عرض", copyLink: "نسخ الرابط", exportCsv: "تصدير CSV", bulkUpload: "رفع جماعي", bulkUpdate: "تحديث جماعي", selectAll: "تحديد الكل", deselectAll: "إلغاء التحديد", selected: "محدد", items: "عناصر", yes: "نعم", no: "لا", name: "الاسم", email: "البريد الإلكتروني", phone: "الهاتف", address: "العنوان", date: "التاريخ", status: "الحالة", total: "الإجمالي", empty: "فارغ", page: "صفحة", of: "من", to: "إلى", from: "من" },
    sidebar: { dashboard: "لوحة التحكم", skus_products: "المنتجات", orders: "الطلبات", profitability: "الربحية", purchase_requests: "طلبات الشراء", purchases: "المشتريات", returns: "المرتجعات", suppliers: "الموردين والمتاجر", tasks: "المهام", team: "الفريق", settings: "الإعدادات", backup_data: "النسخ الاحتياطي", admin_tools: "أدوات الإدارة", platform_admin: "إدارة النظام", emergency_restore: "استعادة طارئة", rate_limit_monitor: "مراقبة المعدل", system_monitoring: "مراقبة النظام", sign_out: "تسجيل الخروج", owner_log: "سجل المالك", no_workspaces: "لا توجد مساحات عمل مخصصة", contact_admin: "اتصل بمسؤول التطبيق لطلب الوصول إلى مساحة العمل", suppliers_stores: "الموردين والمتاجر" },
    ...
    skus: { title: "المنتجات", subtitle: "إدارة مخزون المنتجات", addSku: "إضافة منتج", bulkUpload: "رفع جماعي", bulkUpdate: "تحديث جماعي", exportCsv: "تصدير CSV", template: "تنزيل النموذج", checkIntegrity: "فحص السلامة", resetAllStockToZero: "إعادة تعيين المخزون إلى صفر", clearStock: "مسح المخزون", deleteSelected: "حذف المحدد", searchPlaceholder: "البحث برمز SKU أو العنوان...", filters: { all: "كل المنتجات", lowStock: "مخزون منخفض", outOfStock: "نفد المخزون", newestFirst: "الأحدث أولاً", oldestFirst: "الأقدم أولاً", rowsPerPage: "صفوف في الصفحة" }, empty: { title: "لا توجد منتجات بعد", subtitle: "أضف أول منتج للبدء" }, table: { skuCode: "رمز SKU", title: "العنوان", currentStock: "المخزون الحالي", costPrice: "سعر التكلفة", sellingPrice: "سعر البيع", supplier: "المورد", createdDate: "تاريخ الإنشاء" }, integrity: { title: "فحص سلامة المخزون", checking: "جاري فحص سلامة المخزون...", noIssues: "لم يتم العثور على مشاكل", issuesFound: "تم العثور على مشاكل", fix: "إصلاح المشاكل" }, kpis: { lowStockItems: "عناصر المخزون المنخفضة", totalAvailableQuantity: "إجمالي الكمية المتاحة", stockValue: "قيمة المخزون", totalSkus: "إجمالي المنتجات" }, csvColumns: "أعمدة CSV المطلوبة", columnLabels: { imageUrl: "image_url", stock: "stock", supplier: "supplier", cost: "cost", productName: "product_name", skuCode: "sku_code" }, refresh: "تحديث", delete: "حذف" },
    ...
    messages: { saveSuccess: "تم الحفظ بنجاح", deleteSuccess: "تم الحذف بنجاح", updateSuccess: "تم التحديث بنجاح", uploadSuccess: "تم الرفع بنجاح", copiedToClipboard: "تم النسخ إلى الحافظة", confirmDelete: "هل أنت متأكد من حذف هذا العنصر؟", confirmAction: "هل أنت متأكد من المتابعة؟", noChanges: "لم يتم إجراء أي تغييرات", loading: "جاري التحميل...", pleaseWait: "يرجى الانتظار...", loadingWorkspace: "جاري تحميل مساحة العمل...", loadingData: "جاري تحميل البيانات...", workspaceSwitched: "تم تبديل مساحة العمل بنجاح", errorLoadingData: "خطأ في تحميل البيانات", retryLoad: "إعادة محاولة", selectWorkspace: "اختر مساحة عمل", noAccess: "أنت لا تملك صلاحية الوصول إلى هذا المورد" }
  }
};
